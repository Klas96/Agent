#!/usr/bin/env python3
"""
Simple test script to verify Bitcoin address generation.
"""
...
# Import only the simple Bitcoin utils
from pocketflow.utils.simple_bitcoin_utils import simple_bitcoin_utils
